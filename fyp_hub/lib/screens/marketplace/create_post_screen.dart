        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // UI Change: Updated SegmentedButton to match palette
              SegmentedButton<String>(
                segments: const [
                  ButtonSegment(
                    value: 'projectIdea',
                ...
                style: ButtonStyle(
                  backgroundColor: WidgetStateProperty.resolveWith<Color?>(
                    (states) => states.contains(WidgetState.selected)
                        ? primaryColor // Night Charcoal background when selected
                        : Colors.white, // White background when unselected
                  ),
                  foregroundColor: WidgetStateProperty.resolveWith<Color?>(
                    (states) => states.contains(WidgetState.selected)
                        ? secondaryColor // Ice Blue text/icon when selected
                        : primaryColor, // Night Charcoal text when unselected
                  ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  // UI Change: Add Button using primary color
                  IconButton.filled(
                    onPressed: _addSkill,
              ...
              Wrap(
                ...
                children: _skills.map((skill) {
                  return Chip(
                    ...
                    // UI Change: Ice Blue background with low opacity for tags
                  ...
                  child: _isLoading
                      ...
                      : Text(
                          ...
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            // Button text color is handled by global theme (Ice Blue)
                          ),
                        ),
                ),
              ),
