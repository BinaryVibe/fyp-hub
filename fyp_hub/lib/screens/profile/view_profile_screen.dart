...
class _ViewProfileScreenState extends State<ViewProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios, color: primaryColor), // Dark Icon
          onPressed: () => Navigator.pop(context),
        ),
        actions: [
          IconButton(
            icon: Icon(Icons.edit_note_outlined, color: primaryColor),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
      ...
      body: _isLoading
          ...
          : _buildProfileContent(primaryColor, secondaryColor, subtitleColor),
    );
  }
  ...
  Widget _buildProfileContent(
    ...
    if (_user is Student) {
      final student = _user as Student;
      roleSpecificWidgets = [
        _buildInfoCard('Domain', student.domain, primaryColor, subtitleColor),
        _buildChipList(
          'Skills',
          student.skills,
          primaryColor,
        ...
        child: Column(
          children: [
            ...
            FadeInDown(
              child: CircleAvatar(
                radius: 50,
                // UI Change: Night Charcoal BG
                backgroundColor: primaryColor,
                child: Icon(
                  Icons.person,
                  size: 60,
                  color: secondaryColor, // Ice Blue Icon
                ),
              ),
            ),
            const SizedBox(height: 20),
            ...
            FadeInDown(
              ...
              child: Chip(
                ...
                // UI Change: Night Charcoal BG for contrast
                backgroundColor: primaryColor,
            ...
            const SizedBox(height: 20),
            Divider(color: subtitleColor.withOpacity(0.3), height: 40),
